...
def results_show(frame, group):
    trash, group_results, match_results = fb.group_results(group)
    row = 0
...
# Final stage
tk.Button(final_stage_page, text='1/8', width=10, height=2, command=lambda:raise_frame(group_A)).place(x=10, y=25)
tk.Button(final_stage_page, text='1/4', width=10, height=2, command=lambda:raise_frame(group_B)).place(x=110, y=25)
tk.Button(final_stage_page, text='1/2', width=10, height=2, command=lambda:raise_frame(group_C)).place(x=210, y=25)
tk.Button(final_stage_page, text='3d place', width=10, height=2, command=lambda:raise_frame(group_D)).place(x=310, y=25)
